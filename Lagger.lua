...
local function bomb(tableincrease, tries)
    local safeIncrease = math.clamp(tableincrease, 1, 80)
    local maintable = {}
    local spammedtable = {}
    table.insert(spammedtable, {})
    local z = spammedtable[1]
    for i = 1, safeIncrease do
        local tableins = {}
        table.insert(z, tableins)
        z = tableins
        if i % 10 == 0 then task.wait(0.02) end
    end
    local maximum = math.min(getmaxvalue(safeIncrease) or 9999999, 800)
    for i = 1, maximum do
...
local function startLaggerLoop()
    while laggerEnabled do
        ...
        task.wait(math.max(LAGGER_CONFIG.LoopWaitTime, 0.3))
    end
end
...
Frame.Active = true
Frame.BackgroundColor3 = Color3.fromRGB(0, 30, 13)
...
UIStroke.Color = Color3.fromRGB(102, 255, 153)
...
TitleLabel.TextColor3 = Color3.fromRGB(102, 255, 153)
TitleLabel.Text = "Npaz Lhub"
...
SubLabel.TextColor3 = Color3.fromRGB(102, 255, 153)
SubLabel.Text = "discord.gg/irsh"
...
MinimizeBtn.BackgroundColor3 = Color3.fromRGB(0, 40, 20)
MinimizeBtn.Position = UDim2.new(1, -32, 0, 8)
MinimizeBtn.TextColor3 = Color3.fromRGB(102, 255, 153)
MinimizeBtn.Text = "-"
...
MinStroke.Color = Color3.fromRGB(102, 255, 153)
MinStroke.Parent = MinimizeBtn

local ToggleRow = Instance.new("Frame")
ToggleRow.Position = UDim2.new(0, 10, 0, 48)
ToggleRow.BackgroundColor3 = Color3.fromRGB(0, 45, 20)
...
ToggleStroke.Color = Color3.fromRGB(102, 255, 153)
ToggleStroke.Parent = ToggleRow

local ToggleLabel = Instance.new("TextLabel")
ToggleLabel.BackgroundTransparency = 1
ToggleLabel.TextXAlignment = Enum.TextXAlignment.Left
ToggleLabel.TextColor3 = Color3.fromRGB(102, 255, 153)
...
SwitchBg.BackgroundColor3 = Color3.fromRGB(0, 30, 15)
...
SwitchKnob.BackgroundColor3 = Color3.fromRGB(102, 255, 153)
...
KeybindRow.BackgroundColor3 = Color3.fromRGB(0, 45, 20)
...
KeybindStroke.Color = Color3.fromRGB(102, 255, 153)
KeybindStroke.Parent = KeybindRow

local KeybindLabel = Instance.new("TextLabel")
KeybindLabel.BackgroundTransparency = 1
KeybindLabel.TextXAlignment = Enum.TextXAlignment.Left
KeybindLabel.TextColor3 = Color3.fromRGB(102, 255, 153)
...
KeybindBtn.BackgroundColor3 = Color3.fromRGB(0, 35, 15)
KeybindBtn.TextColor3 = Color3.fromRGB(102, 255, 153)
...
local function setToggle(state)
    ...
    local color = state and Color3.fromRGB(0, 120, 60) or Color3.fromRGB(0, 35, 15)
